...
import TourPageMap9N from "../MapView/TourPageMapm9N";
import ItinaryDetails9NContent from "../ItineraryDetails/ItinararyDetails9NContent";

const TourSingleViewContent9N = () => {
...
export default TourSingleViewContent9N;
