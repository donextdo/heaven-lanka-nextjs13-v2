...
import TourPageMap5N from "../MapView/TourPageMap5N";
import ItinaryDetails5NContent from "../ItineraryDetails/ItinaryDetails5NContent";
import QuoteForm from "../Quotes/QuateForm";

const TourSingleViewContent5N = () => {
...
export default TourSingleViewContent5N;
