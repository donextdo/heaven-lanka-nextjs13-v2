...
import TourPageMap8N from "../MapView/TourPageMapm8N";
import ItinaryDetails8NContent from "../ItineraryDetails/ItineraryDetails8NContent";

const TourSingleViewContent8N = () => {
...
export default TourSingleViewContent8N;
