    ...
    <div className="mb-4">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="w-[50%] xl:w-[180px] bg-transparent h-10 rounded-md border border-gray-300 bg-opacity-0 text-sm cursor-pointer text-black xl:text-white pl-3 pr-3"
        />
        <input
          type="date"
          id="returnDate"
