...
const FooterView = () => {
  ...
  return (
    <div className="pb-[40px]">
      <div className="grid grid-cols-1 md:grid-cols-5 gap-2 lg:gap-5">
        ...
        <div className="col-span-1 md:col-span-1 text-center md:text-left md:text-sm">
          ...
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75" onClick={() => router.push('./aboutUspage')}>About</div>
          <div className="mt-[10px] lg:mt-[20px]  cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Career</div>
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Logistic</div>
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75"
        ...
        <div className="col-span-1 md:col-span-1 text-center md:text-left md:text-sm">
          <div className="font-semibold text-[#077B83] mt-[15px] md:mt-[25px] leading-[26px]">
            Contact
          </div>
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Help/FAQ</div>
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Press</div>
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Affilates</div>
        </div>
        ...
        <div className="col-span-1 md:col-span-1 text-center md:text-left md:text-sm">
          ...
          <div className="mt-[10px] lg:mt-[20px]  cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Press Centre</div>
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Our Blog</div>
          <div className="mt-[10px] lg:mt-[20px] cursor-pointer hover:opacity-75" onClick={() => router.push('./comingSoonPage')}>Low fare tips</div>
        </div>
      </div>
      <div className="mt-[20px] border border-[1px] bg-[#999999] bg-opacity-[56%]">
        <hr />
