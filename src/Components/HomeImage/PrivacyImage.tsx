  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <div className="container absolute mx-auto  top-[120px] md:top-[200px] px-4 xl:px-[180px] md:px-[50px] lg:px-[20px]  md:mt-8">
        <h1 className="font-[volkhov] w-[60px] md:w-[60px] xl-[100px] 2xl:w-[100px] text-[25px] md:text-[35px] lg:text-[45px] xl:text-[55px] lg:text-2xl xl:text-3xl 2xl:text-[64px] font-bold text-[white] leading-[1.3] md:leading-[1.4] lg:leading-[1.5] xl:leading-[1.6] 2xl:leading-[1.2] max-w-sm md:max-w-md drop-shadow-2xl">
          Privacy Policy
        </h1>
