...
import Ella1 from "../../../assets/Tour/4N/10.png";
import Ella2 from "../../../assets/Tour/4N/11.png";
import Ella3 from "../../../assets/Tour/4N/12.png";
import Ella4 from "../../../assets/Tour/4N/13.png";
import Ella5 from "../../../assets/Tour/4N/14.png";
...
const ItinaryDetails8NContent = () => {
  return (
    <div className="flex flex-col  justify-start  mt-[100PX]">
      ...
      {/* ------------------------day06-------------- */}
      <div className="flex flex-col justify-start items-left border-dashed border-l-[3px] border-[#077B83] ">
      <div className="flex flex-row gap-[10px] md:gap-[30px] items-center justify-start mt-[90px]">
         <Image src={image9} alt="item1" className="w-[20px]  md:w-[47px] ml-[-11px] md:ml-[-23px] "  />
          <h1 className="md:text-[44px] md:w-full text-[20px] font-bold font-[volkhov] text-left">
            ...
            <div className="flex flex-col gap-[20px] md:gap-[50px]">
              ...
              <div className="flex flex-col md:gap-[30px]">
                <div className="flex flex-row items-center gap-[20px]">
                  ...
                  <span className="font-semibold">Avani Bentota</span>
                </div>
                <div className="flex flex-row  items-center gap-[20px]">
                  <Image src={iconViewOne} alt="item1" className="w-[24px] h-[20px] md:w-[43px] md:h-[36px]" />
      ...
      <div className="flex flex-col gap-[40px] px-[20px] md:pl-[70px] border-dashed border-l-[3px] border-[#077B83]">
        <h1 className="mt-[90px] md:text-[36px] text-[24px] font-bold font-[volkhov] text-left">
          ...
          <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
                Enjoy the Beaches: Spend time on Bentota&apos;s beautiful sandy
                beaches, sunbathe, swim in the clear waters, or simply relax
                with a book. Some popular beaches include Bentota Beach,
            ...
            <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
                Water Sports: Engage in a variety of water sports such as jet
                skiing, windsurfing, banana boat rides, and snorkeling. There
                are many water sports centers along the beach where you can rent
            ...
            <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
                Boat Safari on Bentota River: Take a boat safari along the
                Bentota River and explore the mangrove forests, spot diverse
                bird species, and maybe even spot crocodiles. You can also visit
                the nearby Kosgoda Turtle Hatchery during the safari. climb and
            ...
            <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
                Visit Kande Viharaya Temple: Explore the Kande Viharaya Temple
                in nearby Aluthgama. This Buddhist temple is known for its
                impressive white stupa, intricate wall paintings, and serene
                atmosphere.
              </span>
            </div>
            <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
                Take a River Safari in Madu Ganga: Visit the Madu Ganga River
                and take a boat safari through the mangrove forests. You&apos;ll have
                the opportunity to see various wildlife, visit small islands,
      ...
      <Image src={image9} alt="item1" className="w-[20px] mt-[50px] md:w-[47px] ml-[-11px] md:ml-[-23px] md:mt-[90px] "  />
          <h1 className="md:text-[44px] md:w-full text-[20px] font-bold font-[volkhov] text-left mt-[50px]  md:mt-[90px]">End</h1>
      </div>
    </div>
  );
};

export default ItinaryDetails8NContent;
