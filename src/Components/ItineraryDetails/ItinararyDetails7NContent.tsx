...
import sigiriya1 from "../../../assets/Tour/4N/1.png";
import sigiriya2 from "../../../assets/Tour/4N/2.png";
import sigiriya3 from "../../../assets/Tour/4N/3.png";
import sigiriya4 from "../../../assets/Tour/4N/4.png";
import Mirissa1 from "../../../assets/Tour/4N/15.png";
import Mirissa2 from "../../../assets/Tour/4N/16.png";
import Mirissa3 from "../../../assets/Tour/4N/17.png";
import Mirissa4 from "../../../assets/Tour/4N/18.png";
import Mirissa5 from "../../../assets/Tour/4N/19.png";
import NuwaraEliya1 from "../../../assets/Tour/5N/1.png";
import NuwaraEliya2 from "../../../assets/Tour/5N/2.png";
import NuwaraEliya3 from "../../../assets/Tour/5N/3.png";
import NuwaraEliya4 from "../../../assets/Tour/5N/4.png";
import NuwaraEliya5 from "../../../assets/Tour/5N/5.png";
import Bentota1 from "../../../assets/Tour/7N/1.png";
import Bentota2 from "../../../assets/Tour/7N/2.png";
import Bentota3 from "../../../assets/Tour/7N/3.png";
import Bentota4 from "../../../assets/Tour/7N/4.png";
import Bentota5 from "../../../assets/Tour/7N/5.png";

const ItinaryDetails7NContent = () => {
  return (
    <div className="flex flex-col justify-start  mt-[100PX]">
          ...
          <div className="flex flex-row gap-[60px] w-full md:w-[570px] font-[400] text-[18px] md:text-[20px] leading-[32px]">
            <div className="flex flex-col gap-[20px] md:gap-[50px]">
              <p>
                ...
                ancient cave temple complex, which is a UNESCO World Heritage
                Site. The Dambulla cave temple is a series of five caves that
                contain numerous statues and paintings related to Gautama Buddha
                and his teachings. The historic city of Dambulla has a rich
                cultural heritage and is also surrounded by several important
                religious sites like the Sigiriya Rock Fortress, Anuradhapura,
                and Polonnaruwa. Today, the town is a major tourist destination
                with many hotels, restaurants, and souvenir shops catering to
                visitors.
              </p>
      ...
      <div>
          ...
          <div className="flex flex-col md:gap-[30px]">
            <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
                ...
                tea while enjoying the stunning views.
              </span>
            </div>
             <div className="flex flex-row gap-[20px] ">
              <Image
       ...
       <div className="flex flex-col items-center px-[20px] gap-[40px] md:pl-[70px]  border-dashed border-l-[3px] border-[#077B83] ">
        ...
        <div className="flex flex-col md:flex-row gap-[30px]">
          <Image src={NuwaraEliya2} alt="item1" className="w-[355px] md:" />
          <Image src={NuwaraEliya3} alt="item1" className="w-[355px] md:" />
          <Image src={NuwaraEliya4} alt="item1" className="w-[355px] md:" />
          <Image src={NuwaraEliya5} alt="item1" className="w-[355px] md:" />
        </div>
      </div>
      {/* --------------------day04---------------------- */}
      <div className="flex flex-col justify-start items-left  border-dashed border-l-[3px] border-[#077B83]  ">
       <div className="mt-[90px] flex flex-row gap-[10px] md:gap-[30px] items-center justify-start">
          <Image src={image9} alt="item1" className="w-[20px] md:w-[47px] ml-[-11px] md:ml-[-23px] " />
          <h1 className="md:text-[44px] md:w-full text-[20px] font-bold font-[volkhov] text-left">
            Day 04 - <span className="text-[#077B83]"> Mirissa</span>
          </h1>
        </div>
        <div className="font-[700] md:text-[20px] md:leading-[28px] text-[14px] leading-[18px] text-[#FA7436] ml-[20px] md:ml-[60px] tracking-[-2%] ">
          (1 Night)
          ...
          <div className="flex flex-row gap-[60px] w-full md:w-[570px] font-[400] text-[18px] md:text-[20px] leading-[32px]">
            <div className="flex flex-col gap-[20px] md:gap-[50px]">
              <p>
                ...
                and exotic marine life. Mirissa is a popular destination among
                tourists and it offers a range of activities including surfing,
                snorkeling, whale and dolphin watching, and beach hopping. The
                village has everything that a traveler needs, from cozy
                accommodation to delicious restaurants serving local and
                international cuisine. Some must-visit places in Mirissa are
                Mirissa Beach, Secret Beach, Parrot Rock, and Coconut Tree Hill.
                Mirissa is also an excellent base for exploring other nearby
                attractions such as Galle Fort, Yala National Park, and
                Unawatuna Beach.
              </p>
            ...
            <div className="flex flex-row gap-[20px] ">
             ...
             <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
                ...
                baby turtles into the sea. ( On the way to airport)
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-start items-left  border-dashed border-l-[3px] border-[#077B83]  ">
       <div className="mt-[90px] flex flex-row gap-[10px] md:gap-[30px] items-center justify-start">
          <Image src={image9} alt="item1" className="w-[20px] md:w-[47px] ml-[-11px] md:ml-[-23px] " />
          <h1 className="md:text-[44px] md:w-full text-[20px] font-bold font-[volkhov] text-left">
            Day 05 -<span className="text-[#077B83]">Bentota</span>
          </h1>
        </div>
        <div className="font-[700] md:text-[20px] md:leading-[28px] text-[14px] leading-[18px] text-[#FA7436] ml-[20px] md:ml-[60px] tracking-[-2%] ">
          (1 Night)
        ...
        <div className="flex flex-col xl:flex-row gap-[50px] mt-[40px] px-[20px] xl:pl-[60px]">
          <div className="flex flex-row gap-[60px] w-full md:w-[570px] font-[400] text-[18px] md:text-[20px] leading-[32px]">
            <div className="flex flex-col gap-[20px] md:gap-[50px]">
              <p>
                The main attraction of Bentota is its pristine sandy beaches,
                which stretch for miles along the coast. The clear blue waters
                of the Indian Ocean are ideal for swimming, sunbathing, and
                various water sports such as jet skiing, windsurfing, and
                snorkeling. The beachfront is lined with resorts, hotels, and
                guesthouses, offering a range of accommodation options for
                visitors.
              </p>
      ...
      <div>
          ...
          <div className="flex flex-col md:gap-[30px]">
            <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
              Enjoy the Beaches: Spend time on Bentota&apos;s beautiful sandy beaches, sunbathe, swim in the
clear waters, or simply relax with a book. Some popular beaches include Bentota Beach,
Induruwa Beach, and Paradise Island.
              </span>
            </div>
             <div className="flex flex-row gap-[20px] ">
              <Image
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
              Water Sports: Engage in a variety of water sports such as jet skiing, windsurfing, banana boat
rides, and snorkeling. There are many water sports centers along the beach where you can
rent equipment and take lessons.
              </span>
            </div>
             <div className="flex flex-row gap-[20px] ">
              <Image
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
              Boat Safari on Bentota River: Take a boat safari along the Bentota River and explore the
mangrove forests, spot diverse bird species, and maybe even spot crocodiles. You can also
visit the nearby Kosgoda Turtle Hatchery during the safari.
             ...
             <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
              Visit Kande Viharaya Temple: Explore the Kande Viharaya Temple in nearby Aluthgama. This
Buddhist temple is known for its impressive white stupa, intricate wall paintings, and serene
atmosphere.
              </span>
            </div>
             <div className="flex flex-row gap-[20px] ">
              ...
              <span className="w-[1200px] font-[400] md:text-[20px] md:leading-[32px] text-[18px] leading-[30px]">
              Take a River Safari in Madu Ganga: Visit the Madu Ganga River and take a boat safari through
the mangrove forests. You&apos;ll have the opportunity to see various wildlife, visit small islands,
and explore the historic Madu Ganga Temple.
              </span>
            </div>
       ...
       <div className="flex flex-col items-center px-[20px] gap-[40px] md:pl-[70px]  border-dashed border-l-[3px] border-[#077B83] ">
        ...
        <div className="flex flex-col md:flex-row gap-[30px]">
          <Image src={Bentota2} alt="item1" className="w-[355px] md:" />
          <Image src={Bentota3} alt="item1" className="w-[355px] md:" />
          <Image src={Bentota4} alt="item1" className="w-[355px] md:" />
          <Image src={Bentota5} alt="item1" className="w-[355px] md:" />
        </div>
      </div>
      {/* --------------06 day---------- */}
      <div className="flex flex-col justify-start items-left  border-dashed border-l-[3px] border-[#077B83] ">
       <div className="mt-[90px] flex flex-row gap-[10px] md:gap-[30px] items-center justify-start">
          <Image src={image9} alt="item1" className="w-[20px] md:w-[47px] ml-[-11px] md:ml-[-23px] " />
          <h1 className="md:text-[44px] md:w-full text-[20px] font-bold font-[volkhov] text-left">
            Day 06 & 07 - <span className="text-[#077B83]"> Colombo</span>
          </h1>
        </div>
        <div className="font-[700] md:text-[20px] md:leading-[28px] text-[14px] leading-[18px] text-[#FA7436] ml-[20px] md:ml-[60px] tracking-[-2%] ">
          (1 Night)
      ...
      <div>
       ...
       <div className="flex flex-col items-center px-[20px] gap-[40px] md:pl-[70px]  border-dashed border-l-[3px] border-[#077B83] ">
        ...
        <div className="flex flex-col md:flex-row gap-[30px]">
          <Image src={image11} alt="item1" className="w-[355px] md:" />
          <Image src={image12} alt="item1" className="w-[355px] md:" />
          <Image src={image13} alt="item1" className="w-[355px] md:" />
          <Image src={image14} alt="item1" className="w-[355px] md:" />
        </div>
      </div>
...
export default ItinaryDetails7NContent;
